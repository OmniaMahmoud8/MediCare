...
function DoctorsPage() {
    ...
    return (
      <section className="flex min-h-[60vh] items-center justify-center px-4">
        <div className="max-w-md rounded-2xl bg-white p-8 text-center shadow-sm">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[#E74F44]/10 text-2xl text-[#E74F44]">
            !
          </div>
  ...
  return (
    <section>
      ...
      {/* Search & Filter */}
      <div className="mb-8 rounded-2xl border border-[#5E2325]/10 bg-white p-5 shadow-sm">
        <div className="grid gap-4 md:grid-cols-[1fr_240px]">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-[#284351]/20 bg-[#EBE3D0]/30 px-4 py-3 text-sm text-[#284351] outline-none transition placeholder:text-[#284351]/45 focus:border-[#5E2325] focus:ring-2 focus:ring-[#5E2325]/10"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-[#284351]/20 bg-[#EBE3D0]/30 px-4 py-3 text-sm text-[#284351] outline-none transition focus:border-[#5E2325] focus:ring-2 focus:ring-[#5E2325]/10"
            >
